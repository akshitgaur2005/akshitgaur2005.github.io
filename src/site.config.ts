...
const config: SiteConfig = {
  ...
  description:
    'Blog feed of an up-and-coming coder',
  // The author of the site, used in the footer, SEO, and RSS feed.
  author: 'Akshit Gaur',
  // Keywords for SEO, used in the meta tags.
  tags: ['Operating Systems', 'rust', 'python', 'machine learning', 'nix', 'guix', 'linux'],
  ...
  navLinks: [
    ...
    {
      name: 'Codeberg',
      url: 'https://codeberg.org/akshitgaur2005/',
      external: true,
    },
  ],
  ...
  socialLinks: {
    github: 'https://codeberg.org/akshitgaur2005/',
    //github: 'https://github.com/akshitgaur2005',
    email: 'mailto:akshitgaur@proton.me',
    linkedin: 'https://www.linkedin.com/in/akshit-gaur-a602902a6/',
